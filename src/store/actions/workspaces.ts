...
import { Workspace, WorkspaceRoutesShortTemplate } from '../../common/types/workspace.type';
...
export const CREATE_WORKSPACE = createAction<
  {
    requestData: { name: string; slug: string; description: string; template: string | null };
  } & NavigationProp,
...
export const SET_WORKSPACE_TEMPLATES = createAction<WorkspaceRoutesShortTemplate[]>(
  `${NAMESPACE}/SET_WORKSPACE_TEMPLATES`
);

export const CLEAR_WORKSPACES = createAction(`${NAMESPACE}/CLEAR_WORKSPACES`);
